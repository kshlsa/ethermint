...
The `x/evm` is part of the [ethermint library](https://pkg.go.dev/github.com/kshlsa/ethermint). For an example of how Ethermint can be used on any Cosmos-SDK chain, please refer to [Fortress](https://www.github.com/kshlsa/fortress).
