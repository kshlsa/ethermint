...
import (
	...
	srvflags "github.com/kshlsa/ethermint/server/flags"
	ethermint "github.com/kshlsa/ethermint/types"
	evmtypes "github.com/kshlsa/ethermint/x/evm/types"

	"github.com/kshlsa/ethermint/testutil/network"
)
...
Example:
	fortressd testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "fortressd", "Home directory of the node's daemon configuration")
...
Example:
	fortressd testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
